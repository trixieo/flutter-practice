            ...
            children: [
              SafeArea(
                child: NavigationRail(
                  //The below extension part basically is like media in html and css. 
                  //it ensures that when the width of the device is less than 600px then the navigation area will not be extended but when it is more than 600px then the navigation rail will be extended.
  ...
  Widget build(BuildContext context) {
     ...
     var favouriteslist = favState.favourites;
      if (favouriteslist.isEmpty){
        return Center(
          child:Text("There is nothing in your favourites.Like something then check it out"))
        ;
    }
    return ListView(
      children: [
        Padding(
          padding: const EdgeInsets.all(20), 
          child: Text("These are your favs; You have ${favouriteslist.length} favourites"),),
